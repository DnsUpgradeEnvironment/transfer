...
for page in meta.index:                                                             # page = 07.1.a,b
    ...
    \n\n#content \
    \ncontent_and_progress: " + txtFct("<i>" + contentText['De'] + "</i>" + meta.loc[page, 'InhaltDe']) + "\
    \n\n#Sources\
    ...
    fileEn.write("---\n\nlanguage: en\
    \nnational_indicator_available: " + txtFct(meta.loc[page, 'Tab_4a_Indikatorenblätter.BezEn']) + "\
    \n\ndns_indicator_definition: " + txtFct(meta.loc[page, 'DefinitionEn']) + "\
    \n\ndns_indicator_intention: "+ txtFct(meta.loc[page, 'IntentionEn']) +"\
    \n\ndata_state: " + dataState['En'] + "\
    \n\nindicator_name: " + txtFct(meta.loc[page, 'Tab_4a_Indikatorenblätter.BezEn']) + "\
    \nsection: " + txtFct(meta.loc[page, 'Tab_2a_Bereiche.BezEn']) + "\
    \npostulate: " + txtFct(meta.loc[page, 'Tab_3a_Postulate.BezEn']) + "\
    \n\n#content \
    \ncontent_and_progress: " + txtFct("<i>" + contentText['En'] + "</i>" + meta.loc[page, 'InhaltEn']) + "\
    \n\n#Sources\
